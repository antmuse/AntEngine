...
#define U8TO64_LE_NOCASE(p)                                                  \
    (((u64)(App2Lower((p)[0]))) |                                           \
     ((u64)(App2Lower((p)[1])) << 8) |                                      \
     ((u64)(App2Lower((p)[2])) << 16) |                                     \
     ((u64)(App2Lower((p)[3])) << 24) |                                     \
     ((u64)(App2Lower((p)[4])) << 32) |                                     \
     ((u64)(App2Lower((p)[5])) << 40) |                                     \
     ((u64)(App2Lower((p)[6])) << 48) |                                     \
     ((u64)(App2Lower((p)[7])) << 56))
...
u64 siphash_nocase(const void* inbuf, const size_t inlen, const u8* k) {
    ...
    switch(left) {
    case 7: b |= ((u64)App2Lower(in[6])) << 48; /* fall-thru */
    case 6: b |= ((u64)App2Lower(in[5])) << 40; /* fall-thru */
    case 5: b |= ((u64)App2Lower(in[4])) << 32; /* fall-thru */
    case 4: b |= ((u64)App2Lower(in[3])) << 24; /* fall-thru */
    case 3: b |= ((u64)App2Lower(in[2])) << 16; /* fall-thru */
    case 2: b |= ((u64)App2Lower(in[1])) << 8; /* fall-thru */
    case 1: b |= ((u64)App2Lower(in[0])); break;
    case 0: break;
    }
